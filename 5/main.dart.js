// Generated by dart2js (ast FE, full emitter), the Dart to JavaScript compiler version: 2.0.0-dev.32.0.
...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    }, null, null, 14, 0, null, 34, 39, 46, 18, 19, 37, 38],
    ...
    ConstantStringMap: {
      ...
      forEach$1: function(_, f) {
        var t1, keys, i, key;
        t1 = H.getTypeArgumentByIndex(this, 0);
        H.functionTypeCheck(f, {func: 1, v: true, args: [t1, H.getTypeArgumentByIndex(this, 1)]});
        keys = H.assertSubtype(this.__js_helper$_keys, "$isList", [t1], "$asList");
    ...
    _ConstantMapKeyIterable: {
      ...
      get$iterator: function(_) {
        var t1, t2;
        t1 = this._map;
        t1 = H.assertSubtype(t1.__js_helper$_keys, "$isList", [H.getTypeArgumentByIndex(t1, 0)], "$asList");
      ...
      get$length: function(_) {
        var t1 = this._map;
        return H.assertSubtype(t1.__js_helper$_keys, "$isList", [H.getTypeArgumentByIndex(t1, 0)], "$asList").length;
      }
    },
    JSInvocationMirror: {
    ...
    Primitives_functionNoSuchMethod_closure: {
      "^": "Closure:31;_box_0,$arguments,namedArgumentList",
    ...
    }, "call$1", "async___nullDataHandler$closure", 2, 0, 50, 15],
    _nullErrorHandler: [function(error, stackTrace) {
      H.interceptedTypeCheck(stackTrace, "$isStackTrace");
      $.Zone__current.handleUncaughtError$2(error, stackTrace);
    }, function(error) {
      return P._nullErrorHandler(error, null);
    }, "call$2", "call$1", "async___nullErrorHandler$closure", 2, 2, 4, 0, 2, 4],
    ...
    }, "call$5", "async___rootHandleUncaughtError$closure", 10, 0, 15],
    ...
    _rootErrorCallback: [function($self, $parent, zone, error, stackTrace) {
      H.interceptedTypeCheck(stackTrace, "$isStackTrace");
      return;
    }, "call$5", "async___rootErrorCallback$closure", 10, 0, 16],
    ...
    }, "call$5", "async___rootCreateTimer$closure", 10, 0, 51],
    ...
    }, "call$5", "async___rootCreatePeriodicTimer$closure", 10, 0, 52],
    _rootPrint: [function($self, $parent, zone, line) {
      H.printString(H.S(H.stringTypeCheck(line)));
    }, "call$4", "async___rootPrint$closure", 8, 0, 53],
    _printToZone: [function(line) {
      $.Zone__current.print$1(0, line);
    }, "call$1", "async___printToZone$closure", 2, 0, 54],
    _rootFork: [function($self, $parent, zone, specification, zoneValues) {
      ...
      return t1;
    }, "call$5", "async___rootFork$closure", 10, 0, 55, 9, 10, 11, 59, 55],
    ...
    _AsyncBroadcastStreamController: {
      ...
      _sendData$1: function(data) {
        ...
        for (t2 = this.$ti, subscription = H.assertSubtype(this._firstSubscription, "$is_BroadcastSubscription", t2, "$as_BroadcastSubscription"); subscription != null; subscription = H.assertSubtype(subscription._async$_next, "$is_BroadcastSubscription", t2, "$as_BroadcastSubscription"))
          subscription._addPending$1(new P._DelayedData(H.assertSubtypeOfRuntimeType(data, t1), null, t2));
      }
    },
    Future: {
      "^": "Object;$ti"
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 4, 0, 2, 4],
    ...
    _LinkedIdentityHashSet: {
      ...
      _findBucketIndex$2: function(bucket, element) {
        ...
        $length = bucket.length;
        for (i = 0; i < $length; ++i) {
          t1 = H.interceptedTypeCheck(bucket[i], "$is_LinkedHashSetCell")._element;
    ...
    MapView: {
      "^": "Object;$ti",
      $index: function(_, key) {
        return H.assertSubtypeOfRuntimeType(this._collection$_map.$index(0, key), H.getTypeArgumentByIndex(this, 1));
      },
      forEach$1: function(_, action) {
        this._collection$_map.forEach$1(0, H.functionTypeCheck(action, {func: 1, v: true, args: [H.getTypeArgumentByIndex(this, 0), H.getTypeArgumentByIndex(this, 1)]}));
      },
      get$isEmpty: function(_) {
    ...
    _Utf8Decoder_convert_addSingleBytes: {
      "^": "Closure:48;$this,codeUnits,startIndex,endIndex",
    ...
    }, "call$1", "core_Uri_decodeComponent$closure", 2, 0, 56, 60],
    ...
    DateTime: {
      ...
      add$1: function(_, duration) {
        return P.DateTime$_withValue(this._core$_value + C.JSInt_methods._tdivFast$1(H.interceptedTypeCheck(duration, "$isDuration")._duration, 1000), true);
      },
    ...
    _ElementCssClassSet: {
      ...
      readClasses$0: function() {
        ...
        for (t2 = this._html$_element.className.split(" "), t3 = t2.length, _i = 0; _i < t3; ++_i) {
    ...
    CssClassSetImpl: {
      ...
      map$1: function(_, f) {
        var t1, t2;
        H.functionTypeCheck(f, {func: 1, args: [P.String]});
        t1 = this.readClasses$0();
        t2 = H.getRuntimeTypeArgument(t1, "SetMixin", 0);
        H.functionTypeCheck(f, {func: 1, args: [t2]});
        return new H.EfficientLengthMappedIterable(H.listSuperNativeTypeCheck(t1, "$isIterable"), H.functionTypeCheck(f, {func: 1, ret: null, args: [t2]}), [t2, null]);
      },
      get$isEmpty: function(_) {
      ...
      add$1: function(_, value) {
        ...
        H.stringTypeCheck(value);
        this._validateToken$1(value);
        t1 = new P.CssClassSetImpl_add_closure(value);
        H.functionTypeCheck(t1, {func: 1, args: [[P.Set, P.String]]});
        s = H.assertSubtype(this.readClasses$0(), "$isSet", [P.String], "$asSet");
        ret = t1.call$1(s);
        this.writeClasses$1(s);
        return H.boolTypeCheck(ret);
      },
      $asEfficientLengthIterable: function() {
        return [P.String];
      },
    ...
    createEventPlugins: [function() {
      return H.assertSubtype([new L.DomEventsPlugin(null), new N.KeyEventsPlugin(null)], "$isList", [N.EventManagerPlugin], "$asList");
    }, "call$0", "modules__createEventPlugins$closure", 0, 0, 57],
    ...
    }, "call$0", "modules__createRandomAppId$closure", 0, 0, 13],
    ...
    NgIf: {
      ...
      set$ngIf: function(newCondition) {
        var t1;
        H.assertHelper(true);
        if (!Q.checkBinding(newCondition, this._prevCondition))
          return;
    ...
    createPlatform: function(injector) {
      ...
      if ($.sharedStylesHost == null) {
        t1 = document;
        t2 = P.String;
        t2 = H.assertSubtype(new P._LinkedIdentityHashSet(0, null, null, null, null, null, 0, [t2]), "$isSet", [t2], "$asSet");
        $.sharedStylesHost = new A.DomSharedStylesHost(t1.head, t2);
      }
      try {
    ...
    coreLoadAndBootstrap_closure: {
      "^": "Closure:25;injector,componentType,appRef",
      call$0: function() {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                component = $.$get$_components().$index(0, t1);
                H.assertHelper(true);
                t2 = component == null;
                if (t2)
                  H.throwExpression(new P.StateError("Could not find a component factory for " + t1.toString$0(0) + "."));
                if (t2)
    ...
    PlatformRefImpl: {
      ...
      init$1: function(injector) {
        var t1, initializers;
        H.assertHelper(true);
        t1 = $._inPlatformCreate;
        if (!t1)
          throw H.wrapException(new T.BaseException("Platforms have to be initialized via `createPlatform`!"));
        this._injector = injector;
        initializers = H.listTypeCheck(injector.$get$2(0, C.MultiToken_NG_PLATFORM_INIT, null));
    ...
    ApplicationRefImpl: {
      ...
      set$_asyncInitDonePromise: function(_asyncInitDonePromise) {
        this._asyncInitDonePromise = H.assertSubtype(_asyncInitDonePromise, "$isFuture", [P.bool], "$asFuture");
      },
      ApplicationRefImpl$3: function(_platform, _zone, _injector) {
        ...
        this.set$_asyncInitDonePromise(this.run$1(new Y.ApplicationRefImpl_closure0(this)));
      ...
      run$1: function(callback) {
        ...
        t3 = new Y.ApplicationRefImpl_run_closure(t1, this, callback, H.assertSubtype(new P._AsyncCompleter(t2, [null]), "$isCompleter", [null], "$asCompleter"));
        zone.toString;
        H.functionTypeCheck(t3, {func: 1});
        zone._innerZone.run$1(t3);
        t1 = t1.result;
      ...
      bootstrap$2: function(componentFactory, $parent) {
        var t1;
        H.assertHelper(true);
        t1 = H.boolConversionCheck(this._asyncInitDone);
        if (!t1)
        ...
        return H.interceptedTypeCheck(this.run$1(new Y.ApplicationRefImpl_bootstrap_closure(this, componentFactory, $parent)), "$isComponentRef");
      },
    ...
    ApplicationRefImpl_closure0: {
      ...
      call$0: function() {
        ...
        t1 = this.$this;
        initializers = H.assertSubtype(t1._injector.$get$2(0, C.MultiToken_NG_APP_INIT, null), "$isList", [P.Function], "$asList");
        ...
        if (asyncInitResults.length > 0) {
          asyncInitDonePromise = H.assertSubtype(P.Future_wait(asyncInitResults, null, false).then$1(new Y.ApplicationRefImpl__closure0(t1)), "$isFuture", t2, "$asFuture");
          ...
          H.assertSubtype(asyncInitDonePromise, "$isFuture", t2, "$asFuture");
        }
    ...
    initReflector_closure13: {
      ...
      }, null, null, 6, 0, null, 6, 13, 25, "call"]
    }
    ...
    Inject: {
      "^": "Object;token<",
      toString$0: function(_) {
        return "@Inject(" + this.token.toString$0(0) + ")";
      }
    }
    ...
    OpaqueToken: {
      ...
      toString$0: ["super$OpaqueToken$toString", function(_) {
        var t1;
        H.assertHelper(true);
        t1 = "OpaqueToken (" + this.super$Object$toString(0) + ") <" + new H.TypeImpl(H.runtimeTypeToString(H.getTypeArgumentByIndex(this, 0)), null).toString$0(0) + ">('" + this._desc + "')";
        return t1;
      }]
    },
    MultiToken: {
      "^": "OpaqueToken;_desc,$ti",
      $eq: function(_, other) {
        if (other == null)
          return false;
        return other instanceof S.MultiToken && this._desc === other._desc;
      },
      get$hashCode: function(_) {
        return H.intTypeCheck(S.OpaqueToken.prototype.get$hashCode.call(this, this));
      },
      toString$0: function(_) {
        var t1;
        H.assertHelper(true);
        t1 = "MultiToken (" + this.super$OpaqueToken$toString(0) + ") <" + new H.TypeImpl(H.runtimeTypeToString(H.getTypeArgumentByIndex(this, 0)), null).toString$0(0) + ">('" + this._desc + "')";
        return t1;
      }
    }
  }], ["", "package:angular/src/core/di/opaque_token.template.dart",, S, {
    "^": "",
    ...
    createDivAndAppend: function(doc, $parent) {
      ...
      return H.interceptedTypeCheck(($parent && C.DivElement_methods).append$1($parent, t1), "$isDivElement");
    },
    ...
    AppView: {
      ...
      setupComponentType$1: function(renderType) {
        ...
        if (!renderType.stylesShimmed) {
          t1 = $.sharedStylesHost;
          t2 = renderType.id;
          renderType.set$_styles(renderType._flattenStyles$3(t2, renderType.templateStyles, []));
          t1.addStyles$1(renderType._styles);
      ...
      detectChanges$0: function() {
        if (this.viewData._skipChangeDetection)
          return;
        H.assertHelper(true);
        var t1 = this.viewData.destroyed;
        if (t1)
      ...
      addShimC$1: function(element) {
        var contentClass = this.componentType._contentAttr;
    ...
    checkBinding: function(oldValue, newValue) {
      if ($.AppViewUtils_throwOnChanges) {
        if (!H.boolConversionCheck(C.C__DevModeEquality.equals$2(oldValue, newValue)))
          throw H.wrapException(new T.ExpressionChangedAfterItHasBeenCheckedException("Expression has changed after it was checked. Previous value: '" + oldValue + "'. Current value: '" + newValue + "'"));
        return false;
      }
    ...
    TemplateRef: {
      ...
      createEmbeddedView$0: function() {
        ...
        view.toString;
        t3 = H.getRuntimeTypeArgument(view, "AppView", 0);
        H.assertSubtypeOfRuntimeType(t1, t3);
        view.set$ctx(t1);
        view.viewData.projectableNodes = t2;
        H.assertSubtype(view.build$0(), "$isComponentRef", [t3], "$asComponentRef");
    ...
    ViewContainer: {
      ...
      attachView$2: function(view, viewIndex) {
        ...
        if (this.nestedViews == null)
          this.set$nestedViews(H.setRuntimeTypeInfo([], [S.AppView]));
        t1 = this.nestedViews;
        ...
        if (refRenderNode != null) {
          t1 = [W.Node];
          S.moveNodesAfterSibling(refRenderNode, H.assertSubtype(S._flattenNestedViewRenderNodes(view.viewData.rootNodesOrViewContainers, H.setRuntimeTypeInfo([], t1)), "$isList", t1, "$asList"));
          $.domRootRendererIsDirty = true;
        }
    ...
    RenderComponentType: {
      ...
      set$_styles: function(_styles) {
        this._styles = H.assertSubtype(_styles, "$isList", [P.String], "$asList");
      },
      _flattenStyles$3: function(compId, styles, target) {
        ...
        for (i = 0; i < styleCount; ++i) {
          ...
          if (!!t2.$isList)
            ...
            C.JSArray_methods.add$1(target, t2.replaceAll$2(style, $.$get$COMPONENT_REGEX(), compId));
        }
        return target;
      }
    }
    ...
    NgZone: {
      ...
      _createInnerZone$2$handleUncaughtError: function(zone, handleUncaughtError) {
        return zone.fork$2$specification$zoneValues(new P._ZoneSpecification(H.functionTypeCheck(handleUncaughtError, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Object, P.StackTrace]}), H.functionTypeCheck(this.get$_run(), {func: 1, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1}]}), H.functionTypeCheck(this.get$_runUnary(), {func: 1, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1, args: [,]},,]}), H.functionTypeCheck(this.get$_runBinary(), {func: 1, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1, args: [,,]},,,]}), null, null, null, null, H.functionTypeCheck(this.get$_scheduleMicrotask(), {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1, v: true}]}), H.functionTypeCheck(this.get$_createTimer(), {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true}]}), null, null, null), P.LinkedHashMap__makeLiteral(["isAngularZone", true]));
      },
      ...
      }, "call$4", "get$_scheduleMicrotask", 8, 0, 14],
      _run$4: [function($self, $parent, zone, fn) {
        ...
        try {
          ...
          implZone = implementation.zone;
          t1 = H.functionTypeCheck(implementation.$function, {func: 1, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1}]}).call$4(implZone, P._parentDelegate(implZone), zone, t1);
          return t1;
        } finally {
          --this._nesting;
          this._checkStable$0();
      ...
      _onErrorWithLongStackTrace$2: [function(error, chain) {
        ...
        t4._sendData$1(t3);
      }, "call$2", "get$_onErrorWithLongStackTrace", 4, 0, 32, 2, 43],
    ...
    debugInjectorEnter: function(token) {
      var t1;
      H.assertHelper(true);
      if (!$.InjectionError_enableBetterErrors)
        return;
      t1 = $._tokenStack;
      if (t1 == null)
        $._tokenStack = H.assertSubtype([token], "$isList", [P.Object], "$asList");
      else
        C.JSArray_methods.add$1(t1, token);
    },
    ...
    noProviderError: function(token) {
      var t1, t2;
      H.assertHelper(true);
      t1 = $.InjectionError_enableBetterErrors;
      if (t1) {
        t1 = $._tokenStack;
        t2 = [P.Object];
        H.assertSubtype(t1, "$isList", t2, "$asList");
        t2 = H.assertSubtype(A.NoProviderError__withAdjacentDeduped(t1, token), "$isList", t2, "$asList");
        $._tokenStack = null;
        return new A.NoProviderError(token, t2, null);
      }
    ...
    NoProviderError: {
      "^": "InjectionError;token<,path,message",
      toString$0: function(_) {
        var t1, t2;
        t1 = this.path;
        t2 = this.token;
        return t1.length === 0 ? "No provider found for " + H.S(t2) : "No provider found for " + H.S(t2) + (": " + C.JSArray_methods.join$1(t1, " -> ") + " -> " + H.S(t2) + '.\n**NOTE**: This path is not exhaustive, and nodes may be missing in between the "->" delimiters. There is ongoing work to improve this error message and include all the nodes where possible. ');
      },
      static: {
        NoProviderError__withAdjacentDeduped: function(input, token) {
          var t1, output, lastElement, t2, _i, element;
          t1 = [P.Object];
          H.assertSubtype(input, "$isList", t1, "$asList");
          if (input == null)
            return H.assertSubtype(C.List_empty0, "$isList", t1, "$asList");
          output = [];
          lastElement = new P.Object();
          for (t2 = input.length, _i = 0; _i < input.length; input.length === t2 || (0, H.throwConcurrentModificationError)(input), ++_i) {
            element = input[_i];
          ...
          return H.assertSubtype(output, "$isList", t1, "$asList");
        }
      }
    }
  }], ["", "package:angular/src/di/errors.template.dart",, D, {
    "^": "",
    ...
    ElementInjector: {
      ...
      get$parent: function(_) {
        ...
        if (t1 == null) {
          ...
          t1 = new G.ElementInjector(t2, t1, null, C.EmptyInjector_null);
          this._parent = t1;
        }
        return t1;
      }
    ...
    HierarchicalInjector: {
      ...
      inject$1: function(token) {
        var result;
        A.debugInjectorEnter(token);
        result = this.injectOptional$1(token);
        if (result === C.C_Object)
    ...
    Injector: {
      ...
      $get$2: function(_, token, notFoundValue) {
        var result;
        A.debugInjectorEnter(token);
        result = this.injectOptional$2(token, notFoundValue);
        if (result === C.C_Object)
          return M.throwsNotFound(this, token);
        A.debugInjectorLeave(token);
        return result;
    ...
    _assertProviders: function(providers) {
      ...
      for (t1 = J.get$iterator$ax(H.listSuperNativeTypeCheck(providers, "$isIterable")), t2 = [P.Object]; t1.moveNext$0();) {
        ...
        if (provider.get$useClass() != null) {
          t3 = H.interceptedTypeCheck(provider.get$useClass(), "$isType");
          factory = $.$get$_factories().$index(0, t3);
          H.assertHelper(true);
          if (factory == null)
            H.throwExpression(new P.StateError("Could not find a factory for " + J.toString$0$(t3) + "."));
        ...
        } else if (J.$eq$(provider.get$useFactory(), "__noValueProvided__") && provider.get$useExisting() == null && !!J.getInterceptor(provider.get$token()).$isType) {
          t3 = H.interceptedTypeCheck(provider.get$token(), "$isType");
          factory = $.$get$_factories().$index(0, t3);
          H.assertHelper(true);
          if (factory == null)
            H.throwExpression(new P.StateError("Could not find a factory for " + H.S(t3) + "."));
        }
      }
    },
    ...
    _RuntimeInjector: {
      ...
      _resolveArgs$2: function(token, deps) {
        ...
        for (i = 0; i < l; ++i) {
          dep = t2.$index(deps, i);
          if (!!J.getInterceptor(dep).$isList)
            result = this._resolveMeta$1(dep);
          else {
            A.debugInjectorEnter(dep);
            result = this.inject$1(dep);
            A.debugInjectorLeave(dep);
          }
          if (result === C.C_Object)
      ...
      _resolveMeta$1: function(metadata) {
        ...
        A.debugInjectorEnter(token);
        result = this.injectOptional$2(token, C.C_Object);
        if (result === C.C_Object)
      ...
      }, "useClass$1", "call$2$deps", "call$1", "get$useClass", 2, 3, 34, 0, 45, 23],
      ...
      }, "useFactory$1", "call$2$deps", "call$1", "get$useFactory", 2, 3, 36, 0, 47, 23],
    ...
    getFactory: function(type) {
      ...
      H.assertHelper(true);
      if (factory == null)
        throw H.wrapException(new P.StateError("Could not find a factory for " + J.toString$0$(type) + "."));
      return factory;
    }
    ...
    BrowserExceptionHandler: {
      ...
      }, "call$2", null, null, null, "get$$call", 2, 4, null, 0, 0, 2, 48, 49],
      $isFunction: 1,
    ...
    PublicTestability: {
      ...
      whenStable$1: [function(callback) {
        ...
        t1._runCallbacksIfReady$0();
      }, "call$1", "get$whenStable", 2, 0, 39, 14],
      ...
      }, "findBindings$2", "call$3", "call$1", "call$2", "get$findBindings", 2, 4, 60, 0, 0, 20, 52, 53],
    ...
    BrowserGetTestability_addToWindow_closure: {
      ...
      }, "call$1", null, null, null, 2, 2, null, 54, 20, 22, "call"]
    },
    BrowserGetTestability_addToWindow_closure0: {
      ...
      call$0: [function() {
        ...
        for (t1 = J.getInterceptor$asx(registry), i = 0; i < t1.get$length(registry); ++i) {
          ...
          for (j = 0; C.JSInt_methods.$lt(j, testabilityCount); ++j)
    ...
    DomSharedStylesHost: {
      ...
      addStyles$1: function(styles) {
        var l, t1, t2, t3, i, style, t4;
        H.assertSubtype(styles, "$isList", [P.String], "$asList");
        for (l = styles.length, t1 = this._stylesSet, t2 = this._rootHost, t3 = t2 && C.HeadElement_methods, i = 0; i < l; ++i) {
          if (i >= styles.length)
            return H.ioore(styles, i);
          style = styles[i];
          if (t1.add$1(0, style)) {
            t4 = document.createElement("style");
            t4.textContent = style;
            t3.append$1(t2, t4);
          }
        }
      },
  ...
  }], ["", "package:angular/src/runtime.template.dart",, Z, {
    "^": "",
    ...
    DefaultValueAccessor: {
      ...
      set$onChange: function(_, onChange) {
        this.onChange = H.functionTypeCheck(onChange, {func: 1, v: true, args: [,]});
      },
      set$onTouched: function(onTouched) {
        this.onTouched = H.functionTypeCheck(onTouched, {func: 1, v: true});
      },
      ...
      registerOnChange$1: function(fn) {
        this.set$onChange(0, new O.DefaultValueAccessor_registerOnChange_closure(H.functionTypeCheck(fn, {func: 1, v: true, args: [,], named: {rawValue: P.String}})));
      },
    ...
    NgModel: {
      ...
      _init$1: function(valueAccessors) {
        ...
        t1 = P.String;
        t1 = new Z.Control(null, null, null, null, new P._AsyncBroadcastStreamController(null, null, 0, null, null, null, null, [null]), H.assertSubtype(new P._AsyncBroadcastStreamController(null, null, 0, null, null, null, null, [t1]), "$isStreamController", [t1], "$asStreamController"), null, null, true, false, null, [null]);
      ...
      ngAfterChanges$0: function() {
        if (this._modelChanged) {
          ...
          var t1 = new U.NgModel_ngAfterChanges_closure(this);
          H.functionTypeCheck(t1, {func: 1, v: true});
          t1.call$0();
    ...
    setUpControl: function(control, dir) {
      ...
      if (H.assertTest(dir.valueAccessor != null))
        H.assertThrow("No value accessor for (" + C.JSArray_methods.join$1(H.assertSubtype([], "$isList", [P.String], "$asList"), " -> ") + ") or you may be missing formDirectives in your directives list.");
      t1 = control.validator;
      control.set$validator(B.Validators_compose([t1, null]));
      dir.valueAccessor.writeValue$1(H.assertSubtypeOfRuntimeType(control._model$_value, H.getRuntimeTypeArgument(control, "AbstractControl", 0)));
      ...
      t2 = new X.setUpControl_closure1(control);
      t1.toString;
      H.functionTypeCheck(t2, {func: 1, v: true});
      t1.set$onTouched(t2);
    },
    _throwError: function(dir, message) {
      var t1 = [P.String];
      H.assertSubtype([], "$isList", t1, "$asList");
      message = message + " (" + C.JSArray_methods.join$1(H.assertSubtype([], "$isList", t1, "$asList"), " -> ") + ")";
    ...
    selectValueAccessor: function(dir, valueAccessors) {
      ...
      for (t1 = valueAccessors.length, defaultAccessor = null, builtinAccessor = null, customAccessor = null, _i = 0; _i < valueAccessors.length; valueAccessors.length === t1 || (0, H.throwConcurrentModificationError)(valueAccessors), ++_i) {
        ...
        if (v instanceof O.DefaultValueAccessor)
          ...
          H.interceptedTypeCheck(v, "$isControlValueAccessor");
          customAccessor = v;
        }
      }
      if (customAccessor != null)
    ...
    setUpControl_closure: {
      "^": "Closure:44;control,dir",
      call$2$rawValue: function(newValue, rawValue) {
        var t1;
        H.stringTypeCheck(rawValue);
        t1 = this.dir;
        t1.viewModel = newValue;
        t1 = t1._update;
        t1.toString;
        H.assertSubtypeOfRuntimeType(newValue, H.getTypeArgumentByIndex(t1, 0));
        if (!t1.get$_mayAddEvent())
          H.throwExpression(t1._addEventError$0());
    ...
    "^": "",
    AbstractControl: {
      "^": "Object;validator,_model$_value,_errors,$ti",
      ...
      updateValueAndValidity$2$emitEvent$onlySelf: function(emitEvent, onlySelf) {
        ...
        this.onUpdate$0();
        t1 = this.validator;
        t1 = t1 != null ? t1.call$1(this) : null;
        this.set$_errors(H.assertSubtype(t1, "$isMap", [P.String, null], "$asMap"));
    ...
    Control: {
      "^": "AbstractControl;_onChange,_rawValue,validator,_model$_value,_valueChanges,_statusChanges,_status,_errors,_pristine,_touched,_model$_parent,$ti",
    ...
    Validators_compose: function(validators) {
      ...
      presentValidators = B.Validators__removeNullValidators(validators);
      if (presentValidators.length === 0)
        return;
      return H.functionTypeCheck(new B.Validators_compose_closure(presentValidators), t1);
    },
    ...
    _executeValidators: function(control, validators) {
      var t1, t2, result, len, i, validator, localResult;
      H.assertSubtype(validators, "$isList", [{func: 1, ret: [P.Map, P.String,,], args: [Z.AbstractControl]}], "$asList");
      t1 = P.String;
      t2 = [t1, null];
      t1 = [t1, null];
      result = H.assertSubtype(H.assertSubtype(new H.JsLinkedHashMap(0, null, null, null, null, null, 0, t2), "$isJsLinkedHashMap", t2, "$asJsLinkedHashMap"), "$isMap", t1, "$asMap");
      for (len = validators.length, i = 0; i < len; ++i) {
        if (i >= validators.length)
          return H.ioore(validators, i);
        validator = validators[i];
        if (H.assertTest(true))
          H.assertThrow("Validator should be non-null");
        localResult = validator.call$1(control);
        if (localResult != null)
          result.addAll$1(0, localResult);
      }
      return H.assertSubtype(result.get$isEmpty(result) ? null : result, "$isMap", t1, "$asMap");
    },
    Validators_compose_closure: {
      "^": "Closure:45;presentValidators",
  ...
  }], ["", "package:angular_tour_of_heroes/app_component.dart",, Q, {
    "^": "",
    AppComponent: {
      "^": "Object;title,heroes,selectedHero"
    }
  }], ["", "package:angular_tour_of_heroes/app_component.template.dart",, V, {
    "^": "",
    viewFactory_AppComponent1: [function(parentView, parentIndex) {
      var t1 = new V._ViewAppComponent1(null, null, null, null, null, null, null, null, H.assertSubtype(P.LinkedHashMap__makeLiteral(["$implicit", null]), "$isMap", [P.String, null], "$asMap"), parentView, null, null, null);
      ...
      return H.assertSubtype(t1, "$isAppView", [Q.AppComponent], "$asAppView");
    }, "call$2", "app_component_template__viewFactory_AppComponent1$closure", 4, 0, 7],
    viewFactory_AppComponent2: [function(parentView, parentIndex) {
      var t1 = new V._ViewAppComponent2(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [P.String, null], "$asMap"), parentView, null, null, null);
      t1.set$viewData(S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex, null));
      t1.componentType = $.ViewAppComponent0__renderType;
      return H.assertSubtype(t1, "$isAppView", [Q.AppComponent], "$asAppView");
    }, "call$2", "app_component_template__viewFactory_AppComponent2$closure", 4, 0, 7],
    viewFactory_AppComponentHost0: [function(parentView, parentIndex) {
      ...
      return t1;
    }, "call$2", "app_component_template__viewFactory_AppComponentHost0$closure", 4, 0, 40],
    ...
    ViewAppComponent0: {
      "^": "AppView;_el_0,_text_1,_el_2,_el_4,_appEl_5,_NgFor_5_9,_appEl_6,_NgIf_6_9,_expr_1,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var parentRenderNode, t1, doc, _text_3, _anchor_5, t2, _anchor_6;
        ...
        this._el_2 = t1;
        this.addShimE$1(t1);
        _text_3 = doc.createTextNode("My Heroes");
        J.append$1$x(this._el_2, _text_3);
        t1 = H.interceptedTypeCheck(S.createAndAppend(doc, "ul", parentRenderNode), "$isUListElement");
        this._el_4 = t1;
        t1.className = "heroes";
        this.addShimC$1(t1);
        t1 = $.$get$ngAnchor();
        _anchor_5 = (t1 && C.Comment_methods).clone$1(t1, false);
        t2 = this._el_4;
        (t2 && C.UListElement_methods).append$1(t2, _anchor_5);
        t2 = new V.ViewContainer(5, 4, this, _anchor_5, null, null, null);
        this._appEl_5 = t2;
        this._NgFor_5_9 = new R.NgFor(t2, null, null, null, new D.TemplateRef(t2, H.interceptedTypeCheck(V.app_component_template__viewFactory_AppComponent1$closure(), "$isFunction")));
        _anchor_6 = C.Comment_methods.clone$1(t1, false);
        J.append$1$x(parentRenderNode, _anchor_6);
        t1 = new V.ViewContainer(6, null, this, _anchor_6, null, null, null);
        this._appEl_6 = t1;
        this._NgIf_6_9 = new K.NgIf(new D.TemplateRef(t1, H.interceptedTypeCheck(V.app_component_template__viewFactory_AppComponent2$closure(), "$isFunction")), t1, false);
        this.init$2(C.List_empty0, null);
        return;
      },
      detectChangesInternal$0: function() {
        var _ctx, t1, currVal_1, t2, t3, changes, collection;
        _ctx = this.ctx;
        t1 = this.viewData._cdState;
        currVal_1 = _ctx.heroes;
        if (this._expr_1 !== currVal_1) {
          t2 = this._NgFor_5_9;
          t2.toString;
          if (H.assertTest(true))
            H.assertThrow("Cannot diff `" + H.S(currVal_1) + "`. " + C.Type_NgFor_FUV.toString$0(0) + " only supports binding to something that implements the `Iterable` interface, such as `List`.");
          t2._ngForOf = currVal_1;
          if (t2._differ == null && true) {
            t2._ngForTrackBy;
            t3 = $.$get$trackByIdentity();
            t2._differ = new R.DefaultIterableDiffer(H.functionTypeCheck(t3, {func: 1, args: [P.int,,]}), null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
          }
        ...
        changes = t2._differ;
        if (changes != null) {
          collection = t2._ngForOf;
          if (!(collection != null))
            collection = C.List_empty0;
          changes = changes.check$1(0, collection) ? changes : null;
          if (changes != null)
            t2._applyChanges$1(changes);
        }
        this._NgIf_6_9.set$ngIf(_ctx.selectedHero != null);
    ...
    _ViewAppComponent1: {
      "^": "AppView;_el_0,_el_1,_text_2,_text_4,_expr_0,_expr_1,_expr_2,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var doc, t1, t2, _text_3;
        doc = document;
        t1 = doc.createElement("li");
        this._el_0 = t1;
        this.addShimE$1(t1);
        t1 = S.createSpanAndAppend(doc, this._el_0);
        this._el_1 = t1;
        t1.className = "badge";
        this.addShimE$1(t1);
        t1 = doc.createTextNode("");
        this._text_2 = t1;
        t2 = this._el_1;
        (t2 && C.SpanElement_methods).append$1(t2, t1);
        _text_3 = doc.createTextNode(" ");
        J.append$1$x(this._el_0, _text_3);
        t1 = doc.createTextNode("");
        this._text_4 = t1;
        J.append$1$x(this._el_0, t1);
        t1 = this._el_0;
        t2 = this.eventHandler1$1(this.get$_handle_click_0_0());
        t1.toString;
      ...
      detectChangesInternal$0: function() {
        var _ctx, local_hero, t1, currVal_0, currVal_1, currVal_2;
        _ctx = this.ctx;
        local_hero = H.interceptedTypeCheck(this.locals.$index(0, "$implicit"), "$isHero");
        t1 = _ctx.selectedHero;
        currVal_0 = local_hero == null ? t1 == null : local_hero === t1;
        if (this._expr_0 !== currVal_0) {
          t1 = H.interceptedTypeCheck(this._el_0, "$isHtmlElement");
          if (currVal_0)
        ...
        currVal_1 = Q.interpolate0(local_hero.id);
        if (this._expr_1 !== currVal_1) {
          this._text_2.textContent = currVal_1;
          this._expr_1 = currVal_1;
        }
        currVal_2 = Q.interpolate0(local_hero.name);
        if (this._expr_2 !== currVal_2) {
          this._text_4.textContent = currVal_2;
          this._expr_2 = currVal_2;
        }
      },
      _handle_click_0_0$1: [function($$event) {
        var local_hero = H.interceptedTypeCheck(this.locals.$index(0, "$implicit"), "$isHero");
        this.ctx.selectedHero = local_hero;
    ...
    _ViewAppComponent2: {
      "^": "AppView;_el_0,_el_1,_text_2,_el_4,_el_5,_text_7,_el_8,_el_9,_el_11,_DefaultValueAccessor_11_5,_NgValueAccessor_11_6,_NgModel_11_7,_expr_0,_expr_1,viewData,locals,parentView,componentType,rootEl,ctx",
      ...
      build$0: function() {
        var doc, t1, _text_3, _text_6, t2, _text_10, t3, subscription_0;
        doc = document;
        t1 = doc.createElement("div");
        H.interceptedTypeCheck(t1, "$isDivElement");
        this._el_0 = t1;
        this.addShimC$1(t1);
        t1 = S.createAndAppend(doc, "h2", this._el_0);
        this._el_1 = t1;
        this.addShimE$1(t1);
        t1 = doc.createTextNode("");
        this._text_2 = t1;
        J.append$1$x(this._el_1, t1);
        _text_3 = doc.createTextNode(" details!");
        J.append$1$x(this._el_1, _text_3);
        t1 = S.createDivAndAppend(doc, this._el_0);
        this._el_4 = t1;
        this.addShimC$1(t1);
        t1 = S.createAndAppend(doc, "label", this._el_4);
        this._el_5 = t1;
        this.addShimE$1(t1);
        _text_6 = doc.createTextNode("id:");
        J.append$1$x(this._el_5, _text_6);
        t1 = doc.createTextNode("");
        this._text_7 = t1;
        t2 = this._el_4;
        ...
        this._el_8 = t1;
        this.addShimC$1(t1);
        t1 = S.createAndAppend(doc, "label", this._el_8);
        this._el_9 = t1;
        this.addShimE$1(t1);
        _text_10 = doc.createTextNode("name:");
        J.append$1$x(this._el_9, _text_10);
        t1 = H.interceptedTypeCheck(S.createAndAppend(doc, "input", this._el_8), "$isInputElement");
        this._el_11 = t1;
        (t1 && C.InputElement_methods).setAttribute$2(t1, "placeholder", "name");
        this.addShimC$1(this._el_11);
        t1 = new O.DefaultValueAccessor(this._el_11, H.functionTypeCheck(new O.closure8(), {func: 1, v: true, args: [,]}), H.functionTypeCheck(new O.closure9(), {func: 1, v: true}));
        this._DefaultValueAccessor_11_5 = t1;
        this.set$_NgValueAccessor_11_6([t1]);
        t1 = this._NgValueAccessor_11_6;
        H.assertSubtype(t1, "$isList", [L.ControlValueAccessor], "$asList");
        t2 = new U.NgModel(null, null, null, null, false, null, null, null, null);
        t2._init$1(t1);
        this._NgModel_11_7 = t2;
        t2 = this._el_11;
        t1 = this.eventHandler1$1(this.get$_handle_input_11_1());
        t2.toString;
        t3 = {func: 1, args: [W.Event]};
        H.functionTypeCheck(t1, t3);
        (t2 && C.InputElement_methods)._addEventListener$3(t2, "input", t1, null);
        t1 = this._el_11;
        t2 = this.eventHandler0$1(this._DefaultValueAccessor_11_5.get$touchHandler());
        t1.toString;
        H.functionTypeCheck(t2, t3);
        (t1 && C.InputElement_methods)._addEventListener$3(t1, "blur", t2, null);
        t1 = this._NgModel_11_7._update;
        t1.toString;
        t2 = H.getTypeArgumentByIndex(t1, 0);
        subscription_0 = H.assertSubtype(new P._BroadcastStream(H.assertSubtype(t1, "$is_StreamControllerLifecycle", [t2], "$as_StreamControllerLifecycle"), [t2]), "$isStream", [t2], "$asStream").listen$1(this.eventHandler1$1(this.get$_handle_ngModelChange_11_0()));
        this.init$2([this._el_0], [subscription_0]);
        return;
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_DefaultValueAccessor_EOZ && 11 === nodeIndex)
          return this._DefaultValueAccessor_11_5;
        if (token === C.MultiToken_NgValueAccessor && 11 === nodeIndex)
      ...
      detectChangesInternal$0: function() {
        ...
        _ctx = this.ctx;
        t1 = this.viewData._cdState;
        this._NgModel_11_7.set$model(_ctx.selectedHero.name);
        this._NgModel_11_7.ngAfterChanges$0();
        if (t1 === 0) {
          t1 = this._NgModel_11_7;
          X.setUpControl(t1._control, t1);
          t1._control.updateValueAndValidity$1$emitEvent(false);
        }
        currVal_0 = Q.interpolate0(_ctx.selectedHero.name);
        if (this._expr_0 !== currVal_0) {
          this._text_2.textContent = currVal_0;
          this._expr_0 = currVal_0;
        }
        currVal_1 = Q.interpolate0(_ctx.selectedHero.id);
        if (this._expr_1 !== currVal_1) {
          this._text_7.textContent = currVal_1;
          this._expr_1 = currVal_1;
        }
      },
      _handle_ngModelChange_11_0$1: [function($$event) {
        this.ctx.selectedHero.name = H.stringTypeCheck($$event);
      }, "call$1", "get$_handle_ngModelChange_11_0", 2, 0, 5],
      _handle_input_11_1$1: [function($$event) {
        var t1, t2;
        t1 = this._DefaultValueAccessor_11_5;
        t2 = J.get$value$x(J.get$target$x($$event));
        t1.onChange.call$1(t2);
      }, "call$1", "get$_handle_input_11_1", 2, 0, 5],
      $asAppView: function() {
        return [Q.AppComponent];
      }
    },
    _ViewAppComponentHost0: {
      "^": "AppView;_compView_0,_AppComponent_0_5,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3, t4;
        t1 = new V.ViewAppComponent0(null, null, null, null, null, null, null, null, null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [P.String, null], "$asMap"), this, null, null, null);
        ...
        if (t2 == null) {
          t2 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_0, C.List_9YE);
          $.ViewAppComponent0__renderType = t2;
        }
        t1.setupComponentType$1(t2);
        this._compView_0 = t1;
        this.rootEl = t1.rootEl;
        t2 = new Q.AppComponent("Tour of Heroes", H.assertSubtype($.$get$mockHeroes(), "$isList", [G.Hero], "$asList"), null);
        this._AppComponent_0_5 = t2;
        ...
        return new D.ComponentRef(this, 0, this.rootEl, this._AppComponent_0_5, [t4]);
      },
      detectChangesInternal$0: function() {
  ...
  }], ["", "package:angular_tour_of_heroes/src/hero.dart",, G, {
    "^": "",
    Hero: {
      "^": "Object;id,name"
    }
  }], ["", "package:angular_tour_of_heroes/src/mock_heroes.dart",, O, {}], ["", "package:angular_tour_of_heroes/src/mock_heroes.template.dart",, O, {
    "^": "",
    ...
    StackZoneSpecification: {
      ...
      }, "call$5", "get$_stack_zone_specification$_handleUncaughtError", 10, 0, 15],
      ...
      }, "call$5", "get$_stack_zone_specification$_errorCallback", 10, 0, 16],
    ...
    main: [function() {
      ...
      if (platform == null) {
        ...
        t1 = P.Object;
        t1 = H.assertSubtype(P.LinkedHashMap__makeLiteral([C.MultiToken_NG_PLATFORM_INIT, [L.createInitDomAdapter(testabilityRegistry)], C.Type_PlatformRef_99U, platform, C.Type_PlatformRefImpl_Eok, platform, C.Type_TestabilityRegistry_IMm, testabilityRegistry]), "$isMap", [t1, t1], "$asMap");
        Y.createPlatform(new A.MapInjector(t1, C.EmptyInjector_null));
      }
      ...
      t2 = t1 == null;
      appInjector = new B._RuntimeInjector(t5, t3, t4, t2 ? C.EmptyInjector_null : t1);
      if (H.assertTest(!t2))
...
;
  ...
  C.MultiToken_NG_APP_INIT = new S.MultiToken("NG_APP_INIT", [P.Function]);
  C.MultiToken_NG_PLATFORM_INIT = new S.MultiToken("NG_PLATFORM_INIT", [P.Function]);
  C.MultiToken_NgValueAccessor = new S.MultiToken("NgValueAccessor", [L.ControlValueAccessor]);
  ...
  $._visited62 = false;
  $._tokenStack = null;
  $.InjectionError_enableBetterErrors = true;
  $._visited43 = false;
  $._visited69 = false;
  $._visited39 = false;
  $._visited38 = false;
  ...
  (function(lazies) {
    ...
    return H.setRuntimeTypeInfo([new G.Hero(11, "Mr. Nice"), new G.Hero(12, "Narco"), new G.Hero(13, "Bombasto"), new G.Hero(14, "Celeritas"), new G.Hero(15, "Magneta"), new G.Hero(16, "RubberMan"), new G.Hero(17, "Dynama"), new G.Hero(18, "Dr IQ"), new G.Hero(19, "Magma"), new G.Hero(20, "Tornado")], [G.Hero]);
  }, "mockHeroes", "windows", "$get$windows", function() {
  ...
  $ = new Isolate();
  init.metadata = [null, "_", "error", "line", "stackTrace", "arg", "p0", "trace", "frame", "self", "parent", "zone", "result", "p1", "callback", "value", "invocation", "f", "arg1", "arg2", "elem", "t", "findInAncestors", "deps", "x", "p2", "event", "e", "b", "element", "sender", "s", "o", "a", "closure", "ref", "err", "arg3", "arg4", "isolate", "arguments", "item", "errorCode", "chain", "object", "clazz", "numberOfArguments", "factory", "stack", "reason", "index", "theError", "binding", "exactMatch", true, "zoneValues", "didWork_", "each", "theStackTrace", "specification", "encodedComponent"];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, v: true, args: [,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, ret: [S.AppView, Q.AppComponent], args: [S.AppView, P.num]}, {func: 1, args: [, P.StackTrace]}, {func: 1, args: [P.int,,]}, {func: 1, args: [P.bool]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, v: true, args: [P.Uint8List, P.String, P.int]}, {func: 1, ret: P.String}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1, v: true}]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone,, P.StackTrace]}, {func: 1, ret: P.AsyncError, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Object, P.StackTrace]}, {func: 1, ret: P.int, args: [P.int, P.int]}, {func: 1, v: true, args: [P.String, P.int]}, {func: 1, v: true, args: [P.String], opt: [,]}, {func: 1, args: [P.String]}, {func: 1, ret: P.Uint8List, args: [,,]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [,], opt: [,]}, {func: 1, args: [R.CollectionChangeRecord, P.int, P.int]}, {func: 1, ret: P.Future}, {func: 1, args: [Y.NgZoneError]}, {func: 1, args: [Y.PlatformRefImpl, Y.NgZone, M.Injector]}, {func: 1, args: [P.String, E.SanitizationService, N.EventManager]}, {func: 1, args: [M.ComponentLoader, V.ComponentResolver]}, {func: 1, args: [Y.NgZone]}, {func: 1, args: [P.String,,]}, {func: 1, v: true, args: [, U.Chain]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1}]}, {func: 1, ret: P.Object, args: [P.Type], named: {deps: [P.List, P.Object]}}, {func: 1, ret: P.Object, args: [P.Object]}, {func: 1, ret: P.Object, args: [P.Function], named: {deps: [P.List, P.Object]}}, {func: 1, v: true, args: [,], opt: [, P.String]}, {func: 1, ret: P.bool}, {func: 1, v: true, args: [P.Function]}, {func: 1, ret: S.AppView, args: [S.AppView, P.num]}, {func: 1, args: [W.Element], opt: [P.bool]}, {func: 1, args: [W.Element, P.bool]}, {func: 1, args: [[P.List, N.EventManagerPlugin], Y.NgZone]}, {func: 1, args: [,], named: {rawValue: P.String}}, {func: 1, args: [Z.AbstractControl]}, {func: 1, args: [P.Zone, P.ZoneDelegate, P.Zone,, P.StackTrace]}, {func: 1, ret: P.int, args: [[P.List, P.int], P.int]}, {func: 1, v: true, args: [P.int, P.int]}, {func: 1, args: [P.Symbol0,,]}, {func: 1, v: true, args: [P.Object]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true}]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true, args: [P.Timer]}]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, P.String]}, {func: 1, v: true, args: [P.String]}, {func: 1, ret: P.Zone, args: [P.Zone, P.ZoneDelegate, P.Zone, P.ZoneSpecification, P.Map]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: [P.List, N.EventManagerPlugin]}, {func: 1, ret: Y.NgZone}, {func: 1, args: [, P.String]}, {func: 1, ret: P.List, args: [W.Element], opt: [P.String, P.bool]}];
